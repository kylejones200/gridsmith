...
Thank you for your interest in contributing to gridsmith! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/YOUR_USERNAME/gridsmith.git
cd gridsmith
```
...
```bash
# Format code
black gridsmith tests

# Check linting
flake8 gridsmith tests
```
...
# Run with coverage
pytest tests/ --cov=gridsmith --cov-report=html
```
...
- Code is formatted: black gridsmith tests
- Linting passes: flake8 gridsmith tests
